export default class ShaderProgram {
	...
	loadShaders(
		...
		if (!this.gl.getShaderParameter(vertexShader, this.gl.COMPILE_STATUS) || debugShaderCompilation) {
			console.log(
		...
		// Check for shader compile errors
		if (!this.gl.getShaderParameter(fragmentShader, this.gl.COMPILE_STATUS) || debugShaderCompilation) {
			console.log(
