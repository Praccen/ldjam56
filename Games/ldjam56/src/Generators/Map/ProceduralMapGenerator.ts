...
export default class ProceduralMap {
  ...
  constructor(
    ...
    this.physicsScene.update(0.0, true, false); // Update static objects (floor) so octree is updated
  ...
  updateFocusRoom(characterPosition: vec2) {
    ...
    // If it's not the same as the current focus room, update the physiobjects and update the focus room
